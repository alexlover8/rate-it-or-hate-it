      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex space-x-2 text-sm">
              ...
              <button className="bg-gray-200 text-gray-700 hover:bg-gray-300 px-3 py-1 rounded-full text-sm transition-colors">
                This Week
              </button>
              <button className="bg-gray-200 text-gray-700 hover:bg-gray-300 px-3 py-1 rounded-full text-sm transition-colors">
                This Month
                  ...
                  <div className="p-5 flex-grow flex flex-col">
                    <div className="mb-2">
                      <Link 
                        ...
                        className="text-xs font-medium text-blue-600 hover:underline uppercase tracking-wide"
                      >
                        {item.category}
                      </Link>
                    </div>
          ...
          <div className="text-center mt-8">
            <Link 
              href="/trending"
              className="inline-flex items-center bg-blue-500 text-white px-6 py-3 rounded-full hover:bg-blue-600 transition-colors font-medium"
            >
        ...
        <div>
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/recent" className="text-blue-600 hover:text-blue-800 flex items-center">
              <span>View all</span>
              <ArrowRight size={16} className="ml-1" />
            </Link>
          </div>
          ...
          <div className="overflow-x-auto pb-4">
            <div className="flex space-x-4" style={{ minWidth: 'max-content' }}>
              {trendingItems.slice(0, 4).reverse().map((item) => (
                <Link href={`/item/${item.id}`} key={`recent-${item.id}`}>
                  <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow w-64">
                    ...
                    <div className="p-4">
                      <h3 className="text-md font-bold text-gray-900 truncate">{item.name}</h3>
