  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        // Fetch top contributors directly from Firestore
        ...
        const contributorsData = contributorsSnapshot.docs.map(doc => {
          ...
          return {
            ...
            badges: data.gamification?.badges?.length || 0,
      ...
      <div className="bg-gradient-to-r from-blue-500 to-purple-600 dark:from-blue-600 dark:to-purple-800 text-white">
        <div className="container mx-auto px-4 py-16 md:py-24">
          <div className="max-w-3xl mx-auto text-center">
            ...
            {/* Changed font-light to font-semibold to make text bolder */}
            <p className="text-xl md:text-2xl font-semibold mb-10 text-blue-100">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            ...
            {/* Fixed the link to point to /category instead of /categories */}
            <Link 
              href="/category"
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/contributors" className="text-amber-600 dark:text-amber-400 hover:text-amber-800 dark:hover:text-amber-300 flex items-center text-sm font-medium bg-amber-50 dark:bg-amber-900/30 px-3 py-1.5 rounded-lg transition-colors">
              <span>View all</span>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
              <div className="grid grid-cols-1 divide-y divide-gray-200 dark:divide-gray-700">
                {topContributors.map((contributor, index) => (
                  <div key={contributor.id} className="p-4 sm:p-5 flex items-center">
                    <div className="flex items-center justify-center w-8 h-8 rounded-full bg-amber-100 dark:bg-amber-900/40 text-amber-600 dark:text-amber-400 font-bold text-sm mr-4">
                      {index + 1}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <Link href={`/profile/${contributor.id}`} className="block truncate font-medium text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                        {contributor.displayName}
                      </Link>
                      <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                        <div className="flex items-center mr-3">
                          <Star className="w-3.5 h-3.5 mr-1 text-blue-500 dark:text-blue-400" />
                          <span>Level {contributor.level}</span>
                        </div>
                        {contributor.submissions > 0 && (
                          <div className="flex items-center">
                            <Plus className="w-3.5 h-3.5 mr-1 text-green-500 dark:text-green-400" />
                            <span>{contributor.submissions} items</span>
                          </div>
                        )}
                      </div>
                    </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-700/30 px-4 py-3 text-center">
                <Link 
                  href="/add-item"
                ...
                >
                  ...
                  Add an item and start earning points
                </Link>
              </div>
            </div>
          ) : (
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 text-center">
              <p className="text-gray-500 dark:text-gray-400">Contributors are loading...</p>
            </div>
          )}
        </div>
